<?php
    ...
    if ($_GET['edicao']) {
        ...
        $sql = "SELECT * FROM categoriaproduto WhERE codigo =?";
...
<html lang="en">
    ...
    <!-- AQUIIIII   -->
                        <div class="card mb-4">
                            <div class="card-header"><i class="fas fa-compass mr-1"></i>Nova Categoria</div>
                            <div class="card-body">
                                <form action="cadastroCategoria.php" method="POST">
                                    ...
                                    <div class="form-group">
										<label class="small mb-1" for="email">Descricao</label>
										<input class="form-control" name="descricao" id="descricao" type="descricao" value="<?php echo $descricao;?>" aria-describedby="descricao" placeholder="Informe a descrição" />
                                    </div>
